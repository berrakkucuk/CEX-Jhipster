...
import static com.cinema.cinema_system.domain.CustomerAsserts.*;
...
import com.cinema.cinema_system.repository.CustomerRepository;
import com.cinema.cinema_system.service.dto.CustomerDTO;
import com.cinema.cinema_system.service.mapper.CustomerMapper;
...
class CustomerResourceIT {
    ...
    public static Customer createEntity(EntityManager em) {
        Customer customer = new Customer().name(DEFAULT_NAME).email(DEFAULT_EMAIL).phoneNumber(DEFAULT_PHONE_NUMBER);
        return customer;
    }
    ...
    public static Customer createUpdatedEntity(EntityManager em) {
        Customer customer = new Customer().name(UPDATED_NAME).email(UPDATED_EMAIL).phoneNumber(UPDATED_PHONE_NUMBER);
        return customer;
    }
    ...
    void putExistingCustomer() throws Exception {
        ...
        updatedCustomer.name(UPDATED_NAME).email(UPDATED_EMAIL).phoneNumber(UPDATED_PHONE_NUMBER);
    ...
    void fullUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.name(UPDATED_NAME).email(UPDATED_EMAIL).phoneNumber(UPDATED_PHONE_NUMBER);
