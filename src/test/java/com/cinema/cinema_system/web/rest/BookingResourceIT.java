...
class BookingResourceIT {
    ...
    private static final LocalDate DEFAULT_MOVIE_TIME = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_MOVIE_TIME = LocalDate.now(ZoneId.systemDefault());
    ...
    public static Booking createEntity(EntityManager em) {
        Booking booking = new Booking().movieTime(DEFAULT_MOVIE_TIME).paymentStatus(DEFAULT_PAYMENT_STATUS);
        return booking;
    }
    ...
    public static Booking createUpdatedEntity(EntityManager em) {
        Booking booking = new Booking().movieTime(UPDATED_MOVIE_TIME).paymentStatus(UPDATED_PAYMENT_STATUS);
        return booking;
    }
    ...
    void getAllBookings() throws Exception {
        ...
        restBookingMockMvc
            ...
            .andExpect(jsonPath("$.[*].movieTime").value(hasItem(DEFAULT_MOVIE_TIME.toString())))
    ...
    void getBooking() throws Exception {
        ...
        restBookingMockMvc
            ...
            .andExpect(jsonPath("$.movieTime").value(DEFAULT_MOVIE_TIME.toString()))
    ...
    void putExistingBooking() throws Exception {
        ...
        updatedBooking.movieTime(UPDATED_MOVIE_TIME).paymentStatus(UPDATED_PAYMENT_STATUS);
    ...
    void partialUpdateBookingWithPatch() throws Exception {
        ...
        partialUpdatedBooking.paymentStatus(UPDATED_PAYMENT_STATUS);
    ...
    void fullUpdateBookingWithPatch() throws Exception {
        ...
        partialUpdatedBooking.movieTime(UPDATED_MOVIE_TIME).paymentStatus(UPDATED_PAYMENT_STATUS);
