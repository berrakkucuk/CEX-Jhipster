...
import com.cinema.cinema_system.service.MovieService;
...
/**
 * REST controller for managing {@link com.cinema.cinema_system.domain.Movie}.
 */
@RestController
...
public class MovieResource {
    ...
    public ResponseEntity<MovieDTO> createMovie(@RequestBody MovieDTO movieDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/movies/" + movieDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, movieDTO.getId().toString()))
            .body(movieDTO);
    }
